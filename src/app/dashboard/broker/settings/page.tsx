...
const navItems: SettingsLayoutNavItem[] = [
  {
    id: "firm-profile",
    label: "Firm profile",
    description: "Showcase your brokerage information",
...
export default function BrokerSettingsPage() {
  ...
  const firmName = useMemo<string>(() => {
    const fallback = (user?.company as string) || "Your brokerage";
  ...
  useEffect(() => {
    setFirmProfile((prev) => ({ ...prev, brokerageName: firmName }));
  }, [firmName]);
  ...
  const renderFirmProfile = () => (
    <Card className="p-6" hover={false}>
      ...
      <p className="mt-1 text-sm text-slate-500">
        Update how prospects and regulators see your brokerage on the platform.
      </p>
      <div className="mt-6 grid gap-5 md:grid-cols-2">
        <InputField
          ...
          value={firmProfile.brokerageName}
          onChange={(event) =>
            setFirmProfile((prev) => ({ ...prev, brokerageName: event.target.value }))
          }
        />
        <InputField
          name="website"
      ...
      <Card className="p-6" hover={false}>
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          ...
          <div className="rounded-2xl border border-slate-200 p-4">
            ...
            <p className="mt-2 text-xs text-slate-500">Orders held until a broker approves the instruction.</p>
  ...
  return (
    <SettingsLayout
      ...
      description="Fine-tune how your brokerage operates across client onboarding, compliance, and real-time alerts."
      navItems={navItems}
