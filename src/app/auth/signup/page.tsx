...
const STEP_FIELDS: ReadonlyArray<ReadonlyArray<StepField>> = [
  ...
  ["country", "city", "gender", "occupation", "investmentExperience", "passportPhoto", "idDocument"],
];
...
export default function SignupPage() {
  ...
  const handleFileUpload = (field: "passportPhoto" | "idDocument") => (value: string) => {
    setFormData((prev) => ({ ...prev, [field]: value }));
    if (value) {
      clearErrorForField(field);
    }
            ...
            {step === 3 && (
              ...
              >
                ...
                <FileUploadField
                  ...
                  onChange={handleFileUpload("passportPhoto")}
                  error={errors.passportPhoto}
                  disabled={isLoading}
                  accept="image/*"
                  helperText="Upload a clear passport-style photo (JPEG, PNG, SVG, etc) up to 10MB"
                  required
                />
                ...
                <FileUploadField
                  ...
                  helperText="Upload your ID document (image or PDF) up to 10MB"
                  required
                />
